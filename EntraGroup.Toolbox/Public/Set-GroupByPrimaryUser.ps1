function Set-GroupByPrimaryUser {
    <#
    .SYNOPSIS
        Adds devices from USers (based on Primary User) to a device based group
    ...
    .NOTES
        ...
        2025-07-17, 1.2:    Updates for Function part of the EntraGroup.Toolbox
